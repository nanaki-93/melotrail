...
class PadMidiGenerationTest {
    ...
    fun `adapter writes full timeline on pad channel without changing source or other generated MIDI`() {
        ...
        val project = Project(Project.CURRENT_VERSION, "pad", listOf(Part("A", "source/A.mid", midi = MidiReferences(clean = "midi/clean/A.mid"))), renderFormat = RenderFormat())
        ...
        val generated = PadMidiGenerationAdapter().generate(projectRoot, project, arrangement, mapOf("A" to analysis))
