...
serialization/hashes, and schema migration.
...
Update mix/style/master/provenance and release gates. Adapt/deprecate Spring and
decide the CLI. Remove legacy code only with usage evidence and migration tests.
...
The generated documentation coverage check stays passing. Stale CLI/module claims
are fixed before a release advertises the composition builder.
