...
| Whole-song critic | [`DeterministicFullSongCritic`](../../src/main/kotlin/app/melotrail/arrangement/FullSongCritic.kt) calculates uncapped aggregate/category evidence, retains a bounded display summary plus complete actionable evidence, and rechecks anchors, harmony, tail collisions, source-groove/voice-leading role evidence, masking, density/contrast, boundaries, and role activity. [`DefaultFullSongEnhancementApplicationService`](../../src/main/kotlin/app/melotrail/application/FullSongEnhancementApplicationService.kt) sends that evidence through hash-bound 32-item batches and rejects no-op/regression candidates or any new critical/blocking/recognizability finding. | A failed planner remains explicit retry evidence, and quality-certified runs cannot select a bypass. Remaining warnings still require a human decision; this does not substitute for QP-017 listening review. | QP-014 complete |
