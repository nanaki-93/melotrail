# Agent Prompt — Milestone 05: Source Song Critic & Approval Gate
...
- Read PLAN.md.
- Read the V2 roadmap milestone file for Milestone 05: Source Song Critic & Approval Gate.
...
Required outcome:
- Create deterministic `SourceSongCritic`.
- Check boundary timing, unexpected gaps/overlaps, extreme jumps, phrase-length anomalies, chord compatibility and identity preservation.
- Produce a structured report.
- Add an explicit source-song approval gate.
- Support rendering the connected source melody alone for listening.

Success criteria:
- Arrangement cannot start with blocking source-song issues unless explicitly overridden.
- Critic report identifies boundary and bar for each issue.
- Source melody can be rendered/previewed independently.
