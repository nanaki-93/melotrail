# Agent Prompt — Milestone 03: Assemble Structured Source Song
...
- Read PLAN.md.
- Read the V2 roadmap milestone file for Milestone 03: Assemble Structured Source Song.
...
Required outcome:
- Create or consolidate `SourceSong`.
- Represent each structure occurrence as a `SectionInstance`.
- Preserve source part ID, section role, occurrence number, start/end bars and canonical harmony.
- Assemble enhanced source MIDI without flattening away section metadata.
- Persist an inspectable source-song artifact.

Success criteria:
- A A B C B becomes distinct A1/A2/B1/C1/B2 instances.
- Each instance retains source/role/occurrence metadata.
- The assembled MIDI timing is valid.
- Arrangement can still distinguish repeated occurrences.
