# Agent Prompt — Milestone 06: Musical Pattern Library
...
- Read PLAN.md.
- Read the V2 roadmap milestone file for Milestone 06: Musical Pattern Library.
...
Required outcome:
- Define typed pattern identifiers and parameter schemas.
- Implement bass algorithms: sustained root, root/fifth, octave, walk-to-next-root, diatonic approach.
- Implement pad voicing strategies: sustained, close, open, common-tone, minimal.
- Create a curated human MIDI groove library for drums.
- Implement transition patterns: drum fill, bass approach, pad sustain, drop/build.
- Make all variation seedable and reproducible.

Success criteria:
- Pattern definitions are independent of Qwen prompts.
- Same input + seed produces identical MIDI.
- Patterns adapt to canonical harmony and tempo.
- No pattern is stored only as an arbitrary raw filename in the AI schema.
