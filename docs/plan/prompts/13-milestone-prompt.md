# Agent Prompt — Milestone 13: Whole-Song Critic & Targeted Polish
...
- Read PLAN.md.
- Read the V2 roadmap milestone file for Milestone 13: Whole-Song Critic & Targeted Polish.
...
Required outcome:
- Expand deterministic critic: groove coherence, bass/melody independence, masking, section contrast, density, repeated-section evolution, transitions and recognizability.
- Produce structured issue locations and severities.
- Make Qwen critic optional and feed it deterministic evidence.
- Make Full-Song Enhance / Polish issue-driven.
- Re-run critic after candidate polish.
- Accept candidate only if critical metrics improve and melody identity does not regress.

Success criteria:
- Polish cannot modify unrelated regions.
- Candidate can be rejected automatically.
- Before/after critic reports are persisted.
- Recognizability is included in acceptance logic.
