# Agent Prompt — Milestone 10: Drums + Pad Core Arrangement
...
- Read PLAN.md.
- Read the V2 roadmap milestone file for Milestone 10: Drums + Pad Core Arrangement.
...
Required outcome:
- Create piano/bass onset and activity maps for drums.
- Generate 2/4-bar drum motifs with controlled section variation.
- Validate kick/bass interaction, backbeat, swing, fills and density.
- Create ensemble-space/register map for pad generation.
- Validate pad harmony, voice leading, melody masking and bass overlap.
- Render a core-arrangement draft.

Success criteria:
- Drum groove relates to bass/piano rhythm.
- Pad can deliberately choose silence when arrangement is dense.
- Core draft can be rendered without strings/extra layers.
- All core tracks are validated before draft approval.
