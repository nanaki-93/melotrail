...
| 8 | [117 — Arrangement compatibility and end-to-end rollout](tasks/completed/117-arrangement-compatibility-and-end-to-end-rollout.md) | Existing arrangement consumes Cohesion and the full UI/docs match the new flow | 116 |
