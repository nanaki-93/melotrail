...
internal fun workflowDescription(step: WorkflowStep): String {
    ...
    return when (step.prerequisite) {
        ...
        WorkflowPrerequisite.GENERATED_MIDI -> "Generate current arrangement MIDI before Cohesion."
        WorkflowPrerequisite.CURRENT_CRITIC -> "Run Critic on the current approved Cohesion output."
        WorkflowPrerequisite.FULL_SONG_ENHANCEMENT_SELECTION -> "Approve a Full-Song Enhance candidate, record no-op, or explicitly bypass it."
